...
class Empresa(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    razon_social = db.Column(db.String(120), unique=True, nullable=False)
    rut = db.Column(db.String(80), unique=True, nullable=False)
    nombre_fantasia = db.Column(db.String(120), unique=False, nullable=False)
    giro = db.Column(db.String(120), unique=False)
    estado = db.Column(db.String(120), unique=False, nullable=False)
    direccion_facturacion = db.Column(db.String(120), unique=False, nullable=False)
    region = db.Column(db.String(120), unique=False, nullable=False)
    comuna = db.Column(db.String(120), unique=False, nullable=False)
    nombre_contacto_facturacion = db.Column(db.String(120), unique=False, nullable=False)
    telefono_contacto_facturacion = db.Column(db.Integer, nullable=False)
    ...
    telefono_contacto_cobranza = db.Column(db.Integer, nullable=False)
