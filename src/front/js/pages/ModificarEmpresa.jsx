...
export const ModificarEmpresa = () => {
  ...
  return (
    <div className="containter row justify-content-center dv-100">
      ...
      <div id="modificar" className="row justify-content-center border border-dark border-2 border-top-0 text-center"><b>M O D I F I C A R</b></div>
      ...
      <div className="col-9 text-center border border-3 border-dark border-top-0 bg-light">
        ...
        <div className="row" onClick={ModificarEmpresaActual => navigate("/modificar_empresa/1")}>
