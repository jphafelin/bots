...
export const ModificarEmpresaId = () => {
  ...
  const grabar = () =>{
    ...
    var myHeaders = new Headers();
     ...
     fetch("https://3001-jphafelin-bots-8ldo44emw7c.ws-eu95.gitpod.io/api/empresa/"+ localStorage.getItem(id_empresa), requestOptions)
  ...
  return (
    ...
    <div id="modificar-titulo" className="justify-content-center text-center border border-dark border-2 border-top-0"><b>M O D I F I C A R</b></div>
      <div>
